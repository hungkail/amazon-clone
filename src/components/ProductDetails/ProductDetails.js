    ...
    <div>
      <div className="productDetails">
        ...
        <div className="productDetails__descriptionContainer">
            ...
            <span className="blueText"><CommentOutlinedIcon /> Report incorrect product information.</span>
            ...
            <div className="productDetails">
                ...
                <div>
                    <span className="blueText">Garden of Life Sport Whey Portein Powder Vanilla, Premium Grass Fed Whey Protein Isolate Plus Probiotics for Immune System Health, 24g Protein, Non GMO, Gluten Free, Cold Processed - 20 Servings</span>
                    <br/><span>1.41 Pound (Pack of 1)</span>
                    <br/><span className="blueText">⭐⭐⭐⭐⭐ (3752)</span>
                    <br/><span className="redText">$41.44 ($1.84/Ounce)</span>
                    <br/><span>Climate Pledge Friendly</span>
                </div>
            </div>
        </div>
      </div>
